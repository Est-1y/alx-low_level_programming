 ...
 * @e_ident: it points to array containing elf magic numbers
...
/**
 * print_class - it prints the class of elf header
 * @e_ident: it points to array containing class elf
 */
void print_class(unsigned char *e_ident)
{
	printf(" Class: ");
...
/**
 * print_data - it rints data of an elf header
 * @e_ident: it points to array containing class elf
 */
void print_data(unsigned char *e_ident)
{
...
/**
 * print_osabi - it Prints the OS and ABI of elf  header
 * @e_ident: it points to array containing the elf version
 */
 ...
 * @e_ident: it  points to the array containing the version of abi
 */
...
/**
 * print_type - it Prints the type of the elf header
 * @e_type: type of elf
 * @e_ident: it points to an array containing the class elf
 */
 ...
 * @e_entry: this is elf entry point
 * @e_ident: it points to an array containing class elf
 */
 ...
 * Description: exit code 98 if file is unclosable
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
